...
namespace SevenDigital.Api.Wrapper.Integration.Tests.EndpointTests.BasketEndpoint
{
	...
	public class BasketCreateTests
	{
		...
		{
			Basket basketCreate = FluentApiFactory.CreateFluentApi<Basket>()
		...
		{
			Basket basket = FluentApiFactory.CreateFluentApi<Basket>()
		...
		public void Can_add_and_remove_release_to_that_basket()
		{
			...
			basket = FluentApiFactory.CreateFluentApi<Basket>()
